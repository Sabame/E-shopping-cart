        ...
        <div id="body">
            <div id="tagline">
                ...
                <?php 
                    ...
                    $quantity = 0;
                    $sql = "SELECT quantity FROM transaction WHERE phone = 'OPPO A94'";
                ...
                <a href="https://www.oppo.com/sg/smartphones/series-a/a94" target="_blank"><p class="more">Learn more</p></a>
          ...
          <div class="slideshow-container" id="slideshow" style="width:45%;postion:absolute;float:right;top:180px; right:0px; border:1px;">
            <div>
              ...
              <div class="mySlides fade">
                ...
                <img  src="image/oppoA94first.jpg" style="width:100%">
                <!--        <div class="text">Caption Text</div>-->
              </div>
              
              <div class="mySlides fade">
                <div class="numbertext">2 / 3</div>
                <img src="image/oppoA94second.jpg" style="width:100%">
                <!--        <div class="text">Caption Two</div>-->
              </div>
              
              <div class="mySlides fade">
                <div class="numbertext">3 / 3</div>
                <img src="image/oppoA94third.jpg" style="width:100%">
