        ...
        <div id="body" >
            <div id="tagline">
                ...
                <?php 
                    ...
                    $quantity = 0;
                    $sql = "SELECT quantity FROM transaction WHERE phone = 'MI 11 LITE'";
                ...
                <table>
                    ...
                    <tr>
                      <td>CPU</td>
                      <td>Qualcomm Snapdragon 780G</td>
                    </tr>
                    <tr>
                        <td>RAM</td>
                        <td>8G</td>
                ...
                <a href="https://www.mi.com/sg/product/mi-11-lite/specs" target="_blank"><p class="more">Learn more</p></a>
            </div>          
          ...
          <div class="slideshow-container" id="slideshow" style="width:45%;postion:absolute;float:right;top:180px; right:0px; border:1px;">
            ...
            <div class="mySlides fade">
              ...
              <img  src="image/mi11first.jpg" style="width:100%">
              <!--        <div class="text">Caption Text</div>-->
            </div>
            
            <div class="mySlides fade">
              <div class="numbertext">2 / 3</div>
              <img src="image/mi11second.jpg" style="width:100%">
              <!--        <div class="text">Caption Two</div>-->
            </div>
            
            <div class="mySlides fade">
              <div class="numbertext">3 / 3</div>
              <img src="image/mi11third.jpg" style="width:100%">
